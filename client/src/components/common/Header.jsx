...
function Header() {
  ...
  useEffect(() => {
    ...
    // פונקציה לבדיקת שינויים ב-localStorage
          ...
          <nav className="hidden lg:flex items-center space-x-6">
            ...
            {isLoggedIn ? (
              <div className="flex items-center">
                <span className="ml-4 text-lg font-medium">שלום, {user?.name || 'משתמש'}!</span>
                <button
            ...
            <div className="flex flex-col space-y-3 text-right">
              ...
              {isLoggedIn ? (
                <div className="flex flex-col space-y-2">
                  <span className="text-lg font-medium">שלום, {user?.name || 'משתמש'}!</span>
                  <button
                    onClick={handleLogout}
